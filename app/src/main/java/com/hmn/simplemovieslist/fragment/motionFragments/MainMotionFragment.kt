...
import kotlinx.android.synthetic.main.fragment_main_motion.*
import kotlin.math.abs

private const val URL = "url"

class MainMotionFragment : Fragment() {
    lateinit var mViewModel: FViewModelImplement

    companion object {
        fun newInstance(url: String): MainMotionFragment = MainMotionFragment()
            .also { f ->
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_main_motion, container, false)

        val playButtom = view.findViewById<ImageView>(R.id.btn_pause)
        val clear: ImageView = view.findViewById<ImageView>(R.id.btn_close_close)

        var isPlaying: Boolean = false
        val youtubePlayer = view.findViewById<YouTubePlayerView>(R.id.player)
        ...
        youtubePlayer.addYouTubePlayerListener(object : AbstractYouTubePlayerListener() {
            ...
            override fun onReady(youTubePlayer: YouTubePlayer) {
                ...
                if (arguments?.containsKey(URL) == true) {
                    videoId = arguments?.getString(URL).toString()
                }
...
//        NewMainMotion.setTransitionListener(object : MotionLayout.TransitionListener {
...
//        NewMainMotion.transitionToEnd()
        ...
        NewMainMotion.setTransitionListener(object : MotionLayout.TransitionListener {
            override fun onTransitionChange(
                ...
                (activity as TestActivity).also {
                    it.mainMotion.progress = abs(progress)
                }
            }
